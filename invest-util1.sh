...
echo "invest-util1 classpath = " $SCRIPT_CLASSPATH

# add project classpath
SCRIPT_CLASSPATH=$SCRIPT_CLASSPATH:./target/invest-utils-0.1.0.jar
echo "full invest-util1 classpath = " $SCRIPT_CLASSPATH

# remove the temp classpath file
rm classpath.out

# run the program
java -cp $SCRIPT_CLASSPATH InvestmentUtil1 $@
